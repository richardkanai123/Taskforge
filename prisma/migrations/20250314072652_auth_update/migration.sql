...
-- DropForeignKey
ALTER TABLE "Comments" DROP CONSTRAINT "Comments_writerId_fkey";
...
-- DropForeignKey
ALTER TABLE "Tasks" DROP CONSTRAINT "Tasks_owner_fkey";
...
CREATE TABLE "Task" (
    ...
    "priority" "Priority" NOT NULL DEFAULT 'L1',
...
-- AddForeignKey
ALTER TABLE "Project" ADD CONSTRAINT "Project_ledById_fkey" FOREIGN KEY ("ledById") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
